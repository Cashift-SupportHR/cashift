...
#include <hikvision/hikvision_plugin.h>
...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) hikvision_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "HikvisionPlugin");
  hikvision_plugin_register_with_registrar(hikvision_registrar);
