...
import 'package:shiftapp/common/components/progress/zoom_widget/progress_zoom_widget.dart';
...
class ArsAlertDialog extends ProgressDialogBackground {
  ///Dialog style
  final DialogStyle? dialogStyle;
...
@deprecated
class BlurDialogBackground extends ProgressDialogBackground {
...
class ProgressZoomDialog extends ProgressDialogBackground {
  ///The (optional) content of the dialog is displayed in the center of the dialog in a lighter font.
  final Widget child;
...
class ProgressDialogBackground extends StatelessWidget {
  ///Widget of dialog, you can use ars_dialog, Dialog, AlertDialog or Custom your own Dialog
  final Widget? dialog;
  ...
  const ProgressDialogBackground(
      {Key? key,
      this.dialog,
      this.color,
      this.dismissable,
