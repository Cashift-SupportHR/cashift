...
import '../../../presentation/shared/models/common_list_item.dart';
...
class Item {
  ...
  final String? code;
  Item({required this.index, required this.value , this.description, this.idString, this.code});

  static List<Item> fromCommonListItem(List<CommonListItem> list) {
...
class _DropdownFiled extends State<DropDownFiledCustom> {
  ...
  Widget build(BuildContext context) {
    ...
    final labelStyle = widget.labelStyle ??
        kTextMedium.copyWith(fontSize: 12, color: kFontDark);
    List<Item> listItems = [];
  ...
  Widget getAndroidPicker(List<Item> listItems) {
    ...
    return DropdownButtonFormField<Item>(
        ...
        decoration: widget.inputDecoration ?? kTextFieldDecoration.copyWith(
          ...
          floatingLabelStyle: kTextLabelFontDark.copyWith(color: kAccent),
                ...
                : Container(
                    ...
                    child: Text(
                      ...
                      style: kTextLabel.copyWith(
                          fontSize: 14, color: disabled ? kGrey_C3 : kFontDark),
                      textAlign: TextAlign.start,
                    ),
                  ),
      );
