...
OpportunityDto _$OpportunityDtoFromJson(
  Map<String, dynamic> json,
) => OpportunityDto(
  id: (json['id'] as num?)?.toInt(),
  freelanceApplyCounter: (json['freelanceApplyCounter'] as List<dynamic>?)
      ?.map((e) => FreelanceApplyCounterDto.fromJson(e as Map<String, dynamic>))
      .toList(),
  ...
  opportunitiesStrartTimeName: json['opportunitiesStrartTimeName'] as String?,
  ...
  completeFreeLanceInfoByCompanyAprovelLevelId:
      (json['completeFreeLanceInfoByCompanyAprovelLevelId'] as num?)?.toInt(),
