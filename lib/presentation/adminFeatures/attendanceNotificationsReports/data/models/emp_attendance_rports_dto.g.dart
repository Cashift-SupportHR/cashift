...
EmpAttendanceRportsDto _$EmpAttendanceRportsDtoFromJson(
  ...
  scheduleEmpAttendanceList:
      (json['scheduleEmpAttendanceList'] as List<dynamic>?)
          ?.map(
            (e) => ScheduleEmpAttendanceListDto.fromJson(
              e as Map<String, dynamic>,
            ),
          )
          .toList(),
  totalScheduleEmpAttendance: (json['totalScheduleEmpAttendance'] as num?)
      ?.toInt(),
