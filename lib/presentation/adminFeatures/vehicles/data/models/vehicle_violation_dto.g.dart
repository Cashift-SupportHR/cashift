...
ContractViolationDto _$ContractViolationDtoFromJson(
  ...
  contractViolationAttachments:
      (json['contractViolationAttachments'] as List<dynamic>?)
          ?.map(
            (e) =>
  ...
  contractViolationTypeId: (json['contractViolationTypeId'] as num?)?.toInt(),
...
ContractViolationAttachment _$ContractViolationAttachmentFromJson(
  Map<String, dynamic> json,
) => ContractViolationAttachment(path: json['path'] as String?);
