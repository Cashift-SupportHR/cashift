...
SaveOrderStatusParams _$SaveOrderStatusParamsFromJson(
  ...
  listShift: (json['listShift'] as List<dynamic>?)
      ...
      .toList(),
  isAcceptedForAllProject: (json['isAcceptedForAllProject'] as num?)?.toInt(),
...
ListProject _$ListProjectFromJson(Map<String, dynamic> json) =>
    ListProject(projectId: (json['projectId'] as num?)?.toInt());

Map<String, dynamic> _$ListProjectToJson(ListProject instance) =>
    <String, dynamic>{'projectId': instance.projectId};

ListShift _$ListShiftFromJson(Map<String, dynamic> json) =>
    ListShift(shiftHeadId: (json['shiftHeadId'] as num?)?.toInt());
