...
ReceiveVehicleDetailsDto _$ReceiveVehicleDetailsDtoFromJson(
  ...
  vehicleTrueComponentsCount: (json['vehicleTrueComponentsCount'] as num?)
      ?.toInt(),
  vehicleTrueCustodiesCount: (json['vehicleTrueCustodiesCount'] as num?)
      ?.toInt(),
  vehicleHandoverImages: (json['vehicleHandoverImages'] as List<dynamic>?)
      ?.map((e) => e as String)
      .toList(),
  vehiclesComponentsHandovers:
      (json['vehiclesComponentsHandovers'] as List<dynamic>?)
          ?.map(
            (e) =>
  ...
  vehiclesCustodiesHandovers:
      (json['vehiclesCustodiesHandovers'] as List<dynamic>?)
