...
class _UserEndpoint implements UserEndpoint {
  ...
  Future<ApiResponse<DownLoadSalaryDefinition>> downLoadSalaryDefinition(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<DownLoadSalaryDefinition> _value;
    try {
      _value = ApiResponse<DownLoadSalaryDefinition>.fromJson(
        _result.data!,
        (json) =>
            DownLoadSalaryDefinition.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<ApiResponse<List<ReceiveVehicleDto>>> fetchReceiveVehicle(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ApiResponse<List<ReceiveVehicleDto>> _value;
    try {
      _value = ApiResponse<List<ReceiveVehicleDto>>.fromJson(
        _result.data!,
        (json) => json is List<dynamic>
            ? json
                .map<ReceiveVehicleDto>((i) =>
                    ReceiveVehicleDto.fromJson(i as Map<String, dynamic>))
                .toList()
            : List.empty(),
      );
    } on Object catch (e, s) {
